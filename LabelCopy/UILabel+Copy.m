...
- (BOOL)canBecomeFirstResponder {
    return [objc_getAssociatedObject(self, @selector(isCopy)) boolValue];
}
...
- (void)setIsCopy:(BOOL)number {
    objc_setAssociatedObject(self, @selector(isCopy), [NSNumber numberWithBool:number], OBJC_ASSOCIATION_ASSIGN);
